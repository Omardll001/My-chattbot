          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="rounded-xl p-4 sm:p-6 border-white/10 border hover:-translate-y-1 transition-all hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)]">
              ...
              <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
                Developing AI-assisted tools at AFRY Industry to automate and optimize industrial automation projects. Building database-driven AI solutions for the generation of PLC/HMI logic and technical documentation using Python/C#, SQL, NLP, LLM and AI-based information retrieval.
              </p>
            ...
            <div className="rounded-xl p-4 sm:p-6 border-white/10 border hover:-translate-y-1 transition-all hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)]">
              ...
              <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
                Integrated an interactive AI chatbot into the portfolio to assist recruiters and visitors. The chatbot answers questions about my personal skills, projects, and background, providing a conversational and engaging experience.
              </p>
              <div className="flex flex-wrap gap-2 mb-3 sm:mb-4">
            ...
            {/* 3. RAG System for IKEA */}
            <div className="rounded-xl p-4 sm:p-6 border-white/10 border hover:-translate-y-1 transition-all hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)]">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">RAG System / MCP Server for IKEA</h3>
              <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
                Designed a Retrieval-Augmented Generation (RAG) tool with a knowledge base of engineering standards with access to <b>+20k documents</b> to help IKEA developers adopt standard workflows and reusable components. Features include contextual recommendations, security compliance, and scalable architecture supporting <b>4000+ users</b>.
              </p>
              <div className="flex flex-wrap gap-2 mb-3 sm:mb-4">
            ...
            {/* 4. Sensor Classification Algorithm for Swegon Group AB */}
            <div className="rounded-xl p-4 sm:p-6 border-white/10 border hover:-translate-y-1 transition-all hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)]">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Sensor Classification Algorithm for Swegon Group AB</h3>
              <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
                Applied the CRISP-DM methodology to classify sensor data (temperature vs. humidity) from smart buildings managed by Swegon Group AB. The project included data cleaning, feature engineering, and evaluation of multiple machine learning models. The Random Forest classifier achieved over <b>89% accuracy</b> on test data and <b>91% accuracy</b> on unseen data, supporting robust deployment for automated sensor monitoring.
              </p>
              <div className="flex flex-wrap gap-2 mb-3 sm:mb-4">
            ...
            {/* 6. Rasts – The Service for Swimrunners */}
            <div className="rounded-xl p-4 sm:p-6 border-white/10 border hover:-translate-y-1 transition-all hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)]">
            ...
            {/* 7. Object Tracking of Football Players */}
            <div className="rounded-xl p-4 sm:p-6 border-white/10 border hover:-translate-y-1 transition-all hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)]">
            ...
            {/* 8. Cloud-based AI Image Recognizer with Flask APIs */}
            <div className="rounded-xl p-4 sm:p-6 border-white/10 border hover:-translate-y-1 transition-all hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)]">
